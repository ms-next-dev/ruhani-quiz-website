  ...
  return (
    <div>
      ...
      <div className="flex justify-center">
        <div
          className={`${hindSiliguriEnglish.className} text-center text-[#FF004C] bg-white/95 py-4 md:py-6 lg:py-8 xl:py-10 px-4 md:px-16 lg:px-16 xl:px-28 tracking-wider rounded-[5px] shadow-lg -mt-12 md:-mt-16 lg:-mt-20 xl:-mt-24 mb-8 lg:mb-12`}
        >
