...
const Banner = () => {
    ...
    return (
        <div className="relative w-full h-[60vh] md:h-[75vh] lg:h-[100vh] overflow-hidden z-0">
            ...
            {/* <div className="container absolute w-full h-full flex justify-start items-center"> */}
